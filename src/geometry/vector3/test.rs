...
mod conversions {
    ...
    fn it_can_build_a_vector3_from_a_normal3() {
        let normal = &Normal3::new(1, 2, 3);
        let subject: Subject<_> = normal.into();
...
mod abs {
    ...
    #[test]
    fn it_can_take_the_absolute_value_of_vector3f_components() {
    ...
    #[test]
    fn it_can_take_the_absolute_value_of_vector3i_components() {
...
mod dot {
    ...
    fn it_returns_the_dot_product_of_the_vector_with_a_normal() {
        ...
        assert_eq!(vector.dot(&normal), 32);
    }
}
...
mod abs_dot {
    ...
    fn it_returns_the_absolute_value_of_the_dot_product_with_a_normal() {
        ...
        assert_eq!(vector.abs_dot(&normal), 32);
    }
}
